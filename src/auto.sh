...
extra_battery_mode() {
    ...
    echo "<p> 초절전 모드로 변경하는중..."
    notification "초절전 모드입니다."
...
battery_mode() {
    ...
    echo "<p> 배커리 모드로 변경하는중..."
    notification "배터리 모드입니다."
...
extra_performance_mode() {
    ...
    echo "<p> 고성능 모드로 변경하는중..."
    notification "고성능 모드입니다."
